...
export class BookListComponent {
  ...
  books: any[] = [
    ...
    },
    {
      ...
      description: 'The worldwide best selling You Do not Know JS book series is back for a 2nd edition: You Do not Know JS Yet. All 6 books are brand new, rewritten to cover all sides of JS for 2020 and beyond.',
    },
    {
      title: 'Pro Git',
